...
<div class="panel-card">
    <form class="product-form" action="/products/add" method="POST" enctype="multipart/form-data">
        <h2 class="form-title">Добавить товар</h2>
    
        <label class="form-label">
            <span>Название товара</span>
            <input type="text" name="title" placeholder="Например: Джинсы Levi's 501" required>
        </label>
        ...
        <label class="form-label">
            <span>Описание</span>
            <textarea name="description" placeholder="Состояние, размер, цвет, комплектация..." rows="4"></textarea>
        </label>
    
        <label class="form-label">
            <span>Цена (₽)</span>
            <input type="number" name="price" min="0" step="1" placeholder="1500" required>
        </label>
        ...
        <label class="form-label">
            ...
            <input type="text" name="seller_contact" placeholder="@telegram, телефон или email" required>
        </label>
